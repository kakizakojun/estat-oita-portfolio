...
- **提言｜一律支援から、データに基づく優先順位付け支援へ**：高齢化率×財政力の2軸で市町村を分類し、両方が深刻な地域に資源を集中。広域連携・行政デジタル化で固定費を下げ、効果を継続モニタリングする（詳細は[提言](#提言いまのデータから何をすべきか-so-what)）。
...
> 散布図で「別データ（財政力）との関係」を可視化し、そこから[提言](#提言いまのデータから何をすべきか-so-what)を導いています。
